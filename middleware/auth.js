...
// Middleware to check if user is in a mess
...
// Middleware to check if user is mess admin
const requireMessAdmin = async (req, res, next) => {
  try {
...
module.exports = { auth, requireMess, requireMessAdmin }; 